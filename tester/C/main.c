...
int main() {
    ...
    while (1) {
        ...
        if (external_query != NULL) {
            int encrypt_len=aes_encrypt(external_query, sizeof(internal_query), keys->aes_key, keys->aes_iv);
        ...
        if (internal_query != NULL) {
            int encrypt_len=aes_encrypt(internal_query, sizeof(internal_query), keys->aes_key, keys->aes_iv);
